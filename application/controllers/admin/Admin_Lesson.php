	...
	public function index()
	{
		if($this->input->post('action') == 'delete'){
			if($this->lesson_m->delete()){
				...
				$this->load->view('admin/lesson_v',array('page' => $page,'lessons' => $lessons));
			}
			...
			$this->load->view('admin/lesson_form_v',array('page' => $page,'lesson' => $lesson, 'cats' => $cats ));
			...
			if($lesson->num_rows() == 1){
				...
				$this->load->view('admin/lesson_form_v',array('page' => $page,'lesson' => $lesson->row(), 'cats' => $cats));
			} else {
