...
class Admin_LessonCat extends CI_Controller {
	...
	public function index()
	{
		if($this->input->post('action') == 'delete'){
			if($this->lessoncat_m->delete()){
				...
				$this->load->view('admin/lessoncat_v',array('page' => $page,'lessoncats' => $lessoncats));
			}
		} else if($this->input->post('action') == 'new'){
			$lessoncat = new stdClass();
			$page['title'] = 'Edit Kelas';
			$this->load->view('admin/lessoncat_form_v',array('page' => $page,'lessoncat' => $lessoncat));
			...
			if($lessoncat->num_rows() == 1){
				$page['title'] = 'Edit Kelas';
				$this->load->view('admin/lessoncat_form_v',array('page' => $page,'lessoncat' => $lessoncat->row()));
			} else {
